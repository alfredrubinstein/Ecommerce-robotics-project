...
import { createRobotAction } from "@/server/BL/actions/robot.action"
...
export default function RobotForm() {
  ...
  return (
   <div className="container mx-auto p-4">
        <h1 className="text-2xl font-bold mb-4">Add New robot</h1>
        
        <form action={createRobotAction} className="space-y-4">
